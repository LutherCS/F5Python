...
'''def task4(new_dict,item)'''

# Find the character which occurs the most in the string and return it (return the one with the greated index in the initial string if there is more than one)
'''def task5(string)'''